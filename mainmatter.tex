...
% impact on the classification quality / performance
...
%In this matrix, off-diagonal elements...
...
%we expect that this will support
...
% drastically / significantly reduces the number of articles a human needs to look at ...
...
\end{enumerate}
% the tense is sometimes mixed-up

%overall, I like the paper very much!
