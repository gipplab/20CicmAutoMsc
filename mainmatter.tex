...
In \citeyear{BarthelTB13} \citeauthor{BarthelTB13} performed automated subject classification for parts of the the zbMATH corpus~\cite{BarthelTB13}.
...
The proposed method was implemented and is currently being used especially to pre-classify general journals~\cite{zbMATH06353861} with few other information like references.
